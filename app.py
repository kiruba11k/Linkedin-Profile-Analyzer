...
def analyze_and_generate_message(prospect_data: dict, sender_info: dict, api_key: str, 
    ...
    if user_instructions and previous_message:
        # Refinement mode
        prompt = f'''Generate a refined LinkedIn connection message following this 3-line structure:

1st line: Something specific about the PROSPECT
2nd line: Your VALUE/INTENTION related to their field
...
4. Line 3: Connection request
5. End with "Best, [Your First Name]"
6. Under 275 characters total
7. No flirty, romantic, or informal language
8. No generic phrases

Generate only the refined message:'''
    else:
        # New generation mode
        prompt = f'''Generate a LinkedIn connection message following this 3-line structure:
